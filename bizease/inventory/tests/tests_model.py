...
class InventorModelTest(TransactionTestCase):
	def test_user_product_name_combo_uniqueness(self):
		...
		product_1 = Inventory(owner=test_user, product_name="Alarm clock", stock_level=50, price=7000, date_added="2025-07-20")
		product_1.save()
		product_2 = Inventory(owner=test_user, product_name="Alarm clock", stock_level=30, price=30000, date_added="2025-07-20")
	...
	def test_product_price_gt_zero_constraint(self):
		...
		product_1 = Inventory(owner=test_user, product_name="product 1", stock_level=50, price=0, date_added="2025-07-20")
		self.assertRaises(IntegrityError, product_1.save)
		product_2 = Inventory(owner=test_user, product_name="product 2", stock_level=30, price=-500, date_added="2025-07-20")
		self.assertRaises(IntegrityError, product_2.save)
	...
	def test_str_representation(self):
		...
		product_1 = Inventory(owner=new_user, product_name="product 2", stock_level=30, price=1500, date_added="2025-07-20")
		product_1.save()
